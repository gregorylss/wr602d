 ...
 */
final class Version20240205151614 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pdf ADD CONSTRAINT FK_EF0DB8C792D057C FOREIGN KEY (subs_pdf_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
